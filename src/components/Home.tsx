                ...
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            ...
                            of mind as the top priority. Here's why thousands
                            trust us to manage their shared expenses.
                        </p>
                    </div>
            ...
            <section className="relative w-full py-24 px-4">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Don't take our word for it. Here's what our users
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-md">
                            ...
                            <p className="text-gray-700 mb-4">
                                "This app has been a lifesaver for our annual
                                ski trip with friends. No more spreadsheets or
                                awkward money conversations. Everyone knows
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-md">
                            ...
                            <p className="text-gray-700 mb-4">
                                "Our apartment of 4 uses this for everything -
                                rent, utilities, groceries, even takeout! The
                                automatic splitting and reminders have
                                eliminated all the friction around money."
                            </p>
                            <div className="flex text-yellow-400">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-md">
                            ...
                            <p className="text-gray-700 mb-4">
                                "Managing office expenses has never been easier.
                                The detailed analytics and seamless integrations
                                with our accounting software have saved us
                                countless hours."
                            </p>
                            <div className="flex text-yellow-400">
                                <svg

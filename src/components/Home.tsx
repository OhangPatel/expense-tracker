...
border border-gray-200 rounded-full shadow-sm"
                        ...
                        <p className="text-gray-600 text-lg md:text-xl max-w-2xl mx-auto">
                            Say goodbye to awkward money talks! Our app makes
                            sharing expenses with roommates, friends and family
                            super simple.
                        </p>
                    </div>
...
const colorClasses = getColorClasses(feature.color as "purple" | "amber" | "blue" | "emerald");                            return (
                                <motion.div
                                    key={index}

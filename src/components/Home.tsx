  ...
  const features = [
    {
      ...
      description: "Divide costs among friends automatically with equal, percentage, or custom splits.",
      icon: (
    ...
    },
    {
      ...
      description: "Create groups for trips, households, or events to keep expenses organized.",
      icon: (
    ...
    },
    {
      ...
      description: "Know who owes what with instant calculations and balance tracking.",
      icon: (
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 relative">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto relative z-10">
              Simplify expense sharing with powerful features designed for everyday use
            </p>
              ...
              >
                <div className="flex flex-col md:flex-row h-full items-center gap-8">
                  ...
                  <div className="w-full md:w-1/2 text-center md:text-left">
                    <div className={`inline-flex p-3 rounded-full bg-gradient-to-r ${feature.color} bg-opacity-10 mb-6 group transform transition-all duration-300 hover:scale-110 hover:shadow-lg`}>
                      {feature.icon}
                    </div>
                    ...
                    <div className={`h-2 w-24 rounded-full bg-gradient-to-r ${feature.color} mx-auto md:mx-0`}></div>
                  </div>
                  
                  {/* Right side - Feature visual */}
                  <div className="w-full md:w-1/2 flex justify-center items-center">
                    <div className={`relative w-64 h-64 md:w-80 md:h-80 bg-gradient-to-r ${feature.color} rounded-2xl shadow-xl overflow-hidden transform transition-all duration-500 hover:scale-105`}>
            ...
            {features.map((_, index) => (
              <button
                ...
                className={`relative transition-all duration-300 ${currentSlide === index 
                  ...
                  : 'w-4 h-4 bg-gray-300 hover:bg-gray-400'} rounded-full overflow-hidden`}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our platform is designed with your financial peace of mind as the top priority.
              Here's why thousands trust us to manage their shared expenses.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Your financial data is encrypted and never shared. We use bank-level security protocols to ensure your information remains private.
                </p>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Track spending patterns, identify areas for savings, and monitor your financial health with beautiful, intuitive visualizations.
                </p>
                <div className="flex items-center text-sm text-green-600">
                  <span className="font-medium">Explore analytics features</span>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4 ml-1">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                  </svg>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Seamless Integrations</h3>
                <p className="text-gray-600 mb-4">
                  Connect with popular payment apps and banking services. Transfer money, settle debts, and reconcile accounts in just a few clicks.
                </p>
                <div className="flex items-center text-sm text-purple-600">
                  <span className="font-medium">See supported integrations</span>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4 ml-1">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                  </svg>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Currency Support</h3>
                <p className="text-gray-600 mb-4">
                  Traveling internationally? No problem. Track expenses in multiple currencies with automatic conversion at current exchange rates.
                </p>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Never chase payments again. Set up automatic reminders for pending settlements and recurring expenses for everyone in your group.
                </p>
                <div className="flex items-center text-sm text-yellow-600">
                  <span className="font-medium">Learn about notification settings</span>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4 ml-1">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                  </svg>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Smart Expense Categories</h3>
                <p className="text-gray-600 mb-4">
                  Automatically categorize your expenses with AI-powered detection. Create custom categories for better financial management.
                </p>
                <div className="flex items-center text-sm text-teal-600">
                  <span className="font-medium">Explore categorization features</span>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4 ml-1">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                  </svg>
                </div>
          ...
          <div className="mt-16 text-center">
            <Link href="/signup" className="inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-8 rounded-lg transition-colors shadow-md">
              <span>Get Started For Free</span>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 ml-2">
                <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
              </svg>
            </Link>
            <p className="text-gray-500 mt-4">No credit card required. Free forever for basic usage.</p>
          </div>
        </div>
      </section>
      ...
      <section className="relative w-full py-24 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Don't take our word for it. Here's what our users have to say about their experience.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center font-bold text-blue-600">JD</div>
                <div>
                  <h4 className="font-semibold text-gray-800">James Donovan</h4>
                  <p className="text-gray-500 text-sm">Travel Group Organizer</p>
                </div>
              </div>
              <p className="text-gray-700 mb-4">
                "This app has been a lifesaver for our annual ski trip with friends. No more spreadsheets or awkward money conversations. Everyone knows exactly what they owe!"
              </p>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center font-bold text-purple-600">EL</div>
                <div>
                  <h4 className="font-semibold text-gray-800">Emily Lin</h4>
                  <p className="text-gray-500 text-sm">Roommate & Household Manager</p>
                </div>
              </div>
              <p className="text-gray-700 mb-4">
                "Our apartment of 4 uses this for everything - rent, utilities, groceries, even takeout! The automatic splitting and reminders have eliminated all the friction around money."
              </p>
              <div className="flex text-yellow-400">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                  <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clipRule="evenodd" />
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center font-bold text-green-600">MS</div>
                <div>
              ...
              <p className="text-gray-700 mb-4">
                "Managing office expenses has never been easier. The detailed analytics and seamless integrations with our accounting software have saved us countless hours."
              </p>
              <div className="flex text-yellow-400">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                  <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clipRule="evenodd" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-16">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-400 mb-6">
                Split expenses with friends and family, track group spending, and settle debts without the awkward conversations. The smart way to manage shared finances.
              </p>
          ...
          <div className="border-t border-gray-700 pt-8 pb-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
              <div className="md:col-span-2">
                ...
                <p className="text-gray-400">Get the latest news, updates and tips delivered directly to your inbox.</p>
              </div>
              <div>
